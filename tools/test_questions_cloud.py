...
QUESTIONS = [
    ...
    ("Q10", "Cine era președintele Curții Constituționale la data pronunțării Deciziei nr. 922/2007?",
             "Ioan Vida"),
    ("Q11", "Ce reglementează Ordinul ministrului internelor și reformei administrative nr. 356/2007 privind transportul în regim de taxi, publicat în Monitorul Oficial nr. 820/3.XII.2007?",
    ...
    ("Q34", "Ce mesaj a transmis Consiliul Frontului Salvării Naționale în comunicatul din 25 decembrie 1989, publicat în MO nr. 2/1989?",
             "Încetarea focului; interzicerea vandalismului; predarea armelor până luni 25 decembrie ora 17; Ministerul de Interne se integrează în Ministerul Apărării"),
